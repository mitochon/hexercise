...
alreadyGuessed (Puzzle _ discovered _ ) c = elem (Just c) discovered
...
fillInCharacter (Puzzle word filledInSoFar s) c = -- [1] [2]
  Puzzle word newFilledInSoFar (c : s) -- [3]
  where zipper guessed wordChar guessChar = -- [4] [5] [6] [7]
          if wordChar == guessed
          then Just wordChar
          else guessChar -- [ 8 ]
        newFilledInSoFar = -- [9]
